  ...
  return (
    <div>
      <Dropdown
        isOpen={dropdownOpen}
        toggle={toggle}
        className="flex justify-end px-[50px] sm:px-[205px] mb-3"
      >
        ...
        <DropdownMenu>
          {category.map((category) => (
            <DropdownItem
              key={category.id}
              tag={Link}
              to={`/shopping/${category.id}/${category.code}`}
            >
              {category.title}
            </DropdownItem>
          ))}
          ...
          <div key={category.id} className="relative">
            ...
            >
              ...
              <div className=" absolute inset-0 flex flex-col justify-center items-center text-center bg-opacity-40 ">
                ...
                <p className="z-10 leading-5 text-sm text-white bg-gray-400 rounded-sm px-1">
