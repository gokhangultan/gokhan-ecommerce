      ...
      {items.map((item, index) => (
        <div
          ...
          className={`cursor-pointer ${
            index !== activeIndex ? "inactive-thumbnail" : ""
          }`}
        >
          <img
            src={product.images[0].url}
    ...
    <div className="">
        ...
        <div className="flex flex-col lg:flex-row gap-5 ">
          ...
          <div className="basis-1/2">
            <div className="flex flex-col gap-3">
              <h4 className="text-xl leading-8 text-textColor ">
                {product.name}
              </h4>
              <div className="flex-row flex gap-2">
                ...
                <h6 className="font-bold text-secondaryColor text-sm leading-6">
                  {product.rating}
                </h6>
              </div>
              <div className="flex-col flex gap-1 mb-4">
                <h3 className="font-bold text-2xl leading text-textColor">
                  $ {product.price}
                </h3>
                <div className="flex flex-row">
                  ...
                  <h6 className="text-sm font-bold leading-6 text-primaryColor">
                    In Stock # {product.stock}{" "}
                  </h6>
                </div>
              </div>
              <p className="text-sm leading-5 text-[#858585]">
                {product.description}
              </p>
              ...
              <div className="flex flex-row gap-3">
                <button className="bg-primaryColor text-white px-[20px] py-[10px] rounded">
                  Select Options
                </button>
      ...
      <section className="product-detail-description mt-5  w-[full] px-[30px] md:px-[195px]">
        <div className="flex flex-row gap-5 justify-center mb-5">
          <button
            className={`text-secondaryColor text-sm leading-6 font-semibold ${
              activeTab === "description" ? "text-[#23856D] font-bold" : ""
            }`}
          ...
          <button
            className={`text-secondaryColor text-sm leading-6 font-semibold ${
              activeTab === "additional" ? "text-[#23856D] font-bold" : ""
            }`}
          ...
          <div className="flex-row flex gap-1">
            <button
              className={`text-secondaryColor text-sm leading-6 font-semibold ${
                activeTab === "reviews" ? "text-[#23856D] font-bold" : ""
              }`}
            ...
            <button
              className={`text-[#23856D] text-sm font-bold leading-6 ${
                activeTab === "reviews" ? "text-[#23856D] font-bold" : ""
              }`}
            >
              (0)
          ...
          <div className="flex flex-col md:flex-row gap-5">
            ...
            >
              <div className="flex-col flex gap-4">
                <h3 className="font-bold text-2xl text-textColor leading-8">
                  {product.name}{" "}
                </h3>
                <p className="text-sm leading-5 text-secondaryColor">
                  {product.description}
                </p>
                <p className="text-sm leading-5 text-secondaryColor">
                  {product.description}
            ...
            <div
              style={{ display: activeTab === "additional" ? "block" : "none" }}
            >
              <div className="flex-col flex gap-4">
                <h3 className="font-bold text-2xl text-textColor leading-8">
                  {product.name}
                ...
                <div className="flex flex-row gap-2">
                  <FontAwesomeIcon
                    ...
                    style={{ color: "#737373" }}
                  />
                  <h6 className="text-sm leading-6 text-secondaryColor font-bold">
