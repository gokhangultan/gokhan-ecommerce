            ...
            <div className="product-card w-[328px] h-[830px] sm:w-[308px] sm:h-[820px] m-3 relative">
                ...
                <div className="flex-col text-left m-3">
                    <div className="flex justify-between mb-3">
                        ...
                        <button className="w-[50px] h-[26px] bg-[#252B42] text-white  text-xs leading-[16px] rounded-xl hover:bg-gray-400"><FontAwesomeIcon icon={faStar} style={{ color: "yellow" }} /> {product.rating}</button>
                    </div>
                    <h5 className="text-[16px] leading-6  font-bold text[#252B42] mb-3">{product.name}</h5>
                    <p className="text-sm leading-5  secondary-text text- mr-3 mb-3">{product.description}</p>
                    <h6 className="font-bol text-sm leading-6  secondary-text  mb-3 font-bold"><FontAwesomeIcon icon={faDownload} /> {product.sell_count} SOLD !</h6>
                    <div className="flex gap-1 mb-3">
                        <h5 className="text-[#BDBDBD] text-[16px] leading-6  font-bold">${product.price}</h5>
                        <h5 className="text-[#23856D] text-[16px] leading-6  font-bold">$6.48</h5>
                    </div>
                    <div className="flex gap-1 mb-3">
                    ...
                    <div className="flex gap-1 mb-3 justify-between">
                        <h6 className="text-xs  leading-4 secondary-text "><FontAwesomeIcon icon={faClock} size="lg" style={{ color: "#23A6F0", }} /> 22hr 30min</h6>
