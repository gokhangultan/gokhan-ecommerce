...
export default function ProductCard() {
    return (
        <div className="flex justify-between border-1 border-gray-150 shadow-sm">
            <div className="product-card w-[308px] h-[604px] sm:w-[308px] sm:h-[604px] m-3 relative ">
                <img src="productcard.jpeg" className="object-cover" />
                <button className="absolute top-[20px] left-[20px] bg-[#E74040] w-[52px] h-[24px] font-container text-[14px] leading-6 font-bold text-white">Sale</button>
                <button className="absolute top-[160px] left-[75px] 2xl:top-[160px] 2xl:left-[75px] xl:top-[160px] xl:left-[75px] lg:top-[120px] lg:left-[55px] md:top-[80px] md:left-[45px] sm:top-[160px] sm:left-[90px]   p-2 rounded-full bg-white w-[40px] h-[40px]"><FontAwesomeIcon icon={faHeart} /></button>
                <button className="absolute top-[160px] left-[125px] 2xl:top-[160px] 2xl:left-[135px] xl:top-[160px] xl:left-[125px] lg:top-[120px] lg:left-[105px] md:top-[80px] md:left-[90px] sm:top-[160px] sm:left-[140px]  p-2 rounded-full bg-white w-[40px] h-[40px]"><FontAwesomeIcon icon={faCartShopping} /></button>
                <button className="absolute top-[160px] left-[175px] 2xl:top-[160px] 2xl:left-[195px] xl:top-[160px] xl:left-[175px] lg:top-[120px] lg:left-[155px] md:top-[80px] md:left-[135px] sm:top-[160px] sm:left-[190px]  p-2 rounded-full bg-white w-[40px] h-[40px]"><FontAwesomeIcon icon={faEye} /></button>
                <div className="flex-col text-left m-3">
                    ...
                    <button className="border-1 border-[#23A6F0] text-[#23A6F0] px-[20px] py-[10px] rounded-[37px] hover:bg-[#23A6F0] hover:text-wh">Learn More <FontAwesomeIcon icon={faChevronRight} /> </button>
                </div>
            </div>
        </div>
    )
