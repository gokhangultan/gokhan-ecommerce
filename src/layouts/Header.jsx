        ...
        <header className={`xl:mx-[118px] lg:mx-[30px] md:mx-[15px] mx-[10px] lg:h-[91px]   ${isMenuVisible ? 'h-[441px]' : ''} pt-4`} >
            <div className='flex '>
                <div className='hidden  sm:hidden xl:flex lg:flex md:hidden basis-2/5 '>
                    <h3 className=' xl:mx-[136px] lg:mx-[40px] md:mx-[20px] mx-[5px] text-[24px] font-bold font- text-[#252B42] leading-8'>BrandName</h3>
                </div>
            ...
            <div className="flex justify-between">
                <div className='flex lg:hidden  '>
                    <h3 className='  xl:mx-[136px] lg:mx-[40px] md:mx-[20px] mx-[5px] text-[24px] font-bold font- text-[#252B42] leading-8 pb-2'>BrandName</h3>
                </div>
