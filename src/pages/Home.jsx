        ...
        <div>
            <div className="relative text-white hero-section">
                ...
                <div className="absolute top-0 left-0 z-10 flex flex-col xl:text-left 2xl:text-left lg:text-left md:text-left sm:text-left xl:py-[290px] lg:py-[180px] md:py-[120px] sm:py-[100px] py-[40px] gap-[1px] 2xl:gap-[24px] xl:gap-[24px] lg:gap-[18px] md:gap-[14px] sm:gap-[12px] xl:ml-[200px] 2xl:ml-[200px] lg:ml-[120px] md:ml-[80px] sm:ml-[60px] ml-[30px]">
                    <div><h5 className="font-2xl:bold 2xl:text-[16px] xl:text-[16px] lg:text-sm md:text-[12px] sm:text-[12px] text-[16px]  leading-[24px]">SUMMER 2020</h5></div>
                    <div>
            ...
            <section className="editor-pick py-[80px] relative text-center">
                ...
                <div className="flex gap-3 justify-center mt-[50px] relative">
                    <div className="flex">
                        ...
                        <button className="absolute  mt-[426px] xl:ml-[31px] sm:ml-[11px] xl:w-[170px] xl:h-[48px] sm:w-[105px] sm:h-[28px] lg:w-[135px] lg:h-[36px] md:sm:w-[125px] md:h-[32px]  w-[85px] h-[24px] z-10 font-bold xl:text-[16px] sm:text-[10px] lg:text-sm md:text-[12px] text-[10px]  hover:text-[#2DC071] bg-white">MEN</button>
                    </div>
                    <div className="flex">
                        <img src="editor.jpeg" className="object-cover w-[250px]  h-[509px]" />
                        <button className="absolute bg-white mt-[434px] xl:ml-[31px] sm:ml-[11px] xl:w-[170px] xl:h-[48px] sm:w-[105px] sm:h-[28px] lg:w-[135px] lg:h-[36px] md:sm:w-[125px] md:h-[32px]  w-[85px] h-[24px] z-10 font-bold xl:text-[16px] sm:text-[10px] lg:text-sm md:text-[12px] text-[10px] hover:text-[#2DC071]">WOMEN</button>
                    </div>
                    <div className="flex-col relative ">
                        <div className="flex mb-2">
                            <img src="editor.jpeg" className="object-cover w-[250px] h-[250px]" />
                            <button className="absolute bg-white mt-[426px] xl:ml-[31px] sm:ml-[11px] xl:w-[170px] xl:h-[48px] sm:w-[105px] sm:h-[28px] lg:w-[135px] lg:h-[36px] md:sm:w-[125px] md:h-[32px]  w-[85px] h-[24px] z-10 font-bold xl:text-[16px] sm:text-[10px] lg:text-sm md:text-[12px] text-[10px] hover:text-[#2DC071]">KIDS</button>
                            <button className="absolute bg-white mt-[176px] xl:ml-[31px] sm:ml-[11px] xl:w-[170px] xl:h-[48px] sm:w-[105px] sm:h-[28px] lg:w-[135px] lg:h-[36px] md:sm:w-[125px] md:h-[32px]  w-[85px] h-[24px] z-10 font-bold xl:text-[16px] sm:text-[10px] lg:text-sm md:text-[12px] text-[10px] hover:text-[#2DC071]">ACCESSORIES</button>
                        </div>
                        <div className="flex">
                            <img src="editor.jpeg" className="object-cover w-[250px] h-[250px]" />
                        </div>
            ...
            <div className="relative text-white carousel-item2 mb-5">
                <div className="">
                    <Carousel2 />
                    <div className="absolute top-[20px] left-[30px] sm:top-[240px] sm:left-[180px] z-10 flex flex-col text-left gap-1 sm:gap-5 carousel-2 w-[300px] sm:w-[500px]">
                        <div><h5 className="text-xl font-bold  leading-[24px]">SUMMER 2020</h5></div>
                        <div>
                            <h1 className="font-bold text-4xl sm:text-6xl leading-[80px]">Vita Classic Product</h1>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between gap-2 ">
                            <button className="button text-white border-none text-2xl leading-8 font-bold hover:bg-green-500 ">$16.48</button>
                            <button className="carousel-button hover:bg-white hover:text-green-500 ">ADD TO CART</button></div>
                    </div>
                </div>
            </div>
