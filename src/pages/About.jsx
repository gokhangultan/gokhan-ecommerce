        ...
        <div className="mt-5 ">
            ...
            <div className="px-[50px] md:px-[255px] collection-text">
                <div className="pt-[100px]  ">
                    ...
                    <div className="flex md:flex-row flex-col justify-between gap-[80px]">
                        ...
                        <div className="flex basis-2/3">
                            <p className="text-secondaryColor text-sm leading-5 text-start">Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative pt-5 justify-center flex">
                    ...
                    {!isPlaying && (
                        <button className="bg-primaryColor rounded-full w-[52px] h-[52px] md:w-[92px] md:h-[92px] absolute z-10 top-[50%] left-[50%] transform translate-x-[-50%]" onClick={handlePlay}>
            ...
            <div className="flex flex-col md:flex-row justify-between bg-[#2A7CC7] ">
                <div className="flex-col  basis-1/3 flex justify-center gap-4 mx-20 sm:mx-40 py-5 collection-text ">
                    ...
                    <div><button className="border-1 border-white px-4 py-2 rounded-md text-white sm:w-[193px] w-[123px] h-[52px] hover:bg-gray-300 hover:text-primaryColor">Button</button></div>
                </div>
